...
if __name__ == '__main__':
    ...
    main.test(
        trained_model_path=r"C:\XXX\pitbox\XXX\XXX\faster-r-cnn-tf\OpenImagesDataset\models\model_frcnn.vgg_0218.hdf5",
        config_path=r"C:\X\XX\XXX\XXXX\faster-r-cnn-tf\OpenImagesDataset\config.pickle",
        input_images_dir_path=r"C:\XXX\X\X\X\faster-r-cnn-tf\OpenImagesDataset\images\test",
        output_dir_path=r"C:\XXXXX\XX\faster-r-cnn-tf\OpenImagesDataset\images\output")
